...
const PARTY_MEMBERS = [
  {
    ...
    health: 70, stamina: 80, morale: 55,
  ...
  },
  {
    ...
    health: 60, stamina: 50, morale: 75,
  ...
  },
  {
    ...
    health: 65, stamina: 60, morale: 85,
  ...
  },
  {
    ...
    health: 70, stamina: 40, morale: 70,
  ...
  },
  {
    ...
    health: 75, stamina: 85, morale: 50,
  ...
  },
  {
    ...
    health: 60, stamina: 55, morale: 65,
  ...
  },
  {
    ...
    health: 65, stamina: 60, morale: 60,
  ...
  },
  {
    ...
    health: 65, stamina: 65, morale: 55,
  ...
  },
  {
    ...
    health: 70, stamina: 60, morale: 50,
  ...
  },
  {
    ...
    health: 55, stamina: 50, morale: 60,
  ...
  },
  {
    ...
    health: 75, stamina: 70, morale: 60,
  ...
  },
  {
    ...
    health: 70, stamina: 65, morale: 65,
  ...
  },
  {
    ...
    health: 80, stamina: 85, morale: 45,
  ...
  },
  {
    ...
    health: 65, stamina: 40, morale: 85,
...
const EVENTS = [
  // --- 🐙 CTHULHU (Feb, Apr, Jun, Sep, Dec) ---
  {
    ...
    choices: [
      { text: 'Try to sleep through it', effects: { sanity: -5, health: -5 } },
      { text: 'Research the dreams', effects: { sanity: -6, hope: -3 }, reveal: 'You find references to R\'lyeh. You wish you hadn\'t.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Read it', effects: { sanity: -8 }, reveal: 'The words don\'t stay on the page. Neither do you, briefly.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Investigate', effects: { sanity: -6, health: -8 }, reveal: 'You saw something in the water. It saw you back.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Hear them out', effects: { sanity: -5, money: -50 }, reveal: 'You bought a starter kit. It whispers at night.' },
      { text: 'Report to the FTC', requires: ['conspiracy-theorist'], effects: { morale: 8, sanity: -3 }, reveal: 'The FTC investigates. Finds nothing. The Deep One is now a registered LLC.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Watch the coast', effects: { sanity: -6, hope: -5 }, reveal: 'You see a shape. It sees you. It waves. It has too many arms.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Infiltrate', effects: { sanity: -6, hope: -5 }, reveal: 'The cult leader is a management consultant. You can\'t tell which is worse.' },
      { text: 'Join enthusiastically', requires: ['cultist'], effects: { sanity: 5, morale: -6, supplies: 3 }, reveal: 'The Cultist finally feels at home. Nobody else does.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Read one', effects: { sanity: -5, morale: 8 }, reveal: 'Chapter 1: "Embrace the void." Chapter 2: "The void has excellent benefits."' },
      { text: 'Mock it', effects: { morale: 8, sanity: -2 } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Endure it', effects: { sanity: -8, hope: -6 } },
      { text: 'Perform a ritual', effects: { sanity: -6, supplies: -5, hope: 5 }, reveal: 'The ritual works. You think. Reality stops hiccuping. Mostly.' },
      { text: 'Embrace the Old Ones', requires: ['cultist'], effects: { sanity: 10, morale: -8, hope: -8 }, reveal: 'The Cultist ascends. You can\'t tell if they\'re still your friend. They might not be able to tell either.' },
    ]
  },
  ...
  // --- 🤖 AI SINGULARITY (Feb, May, Sep, Nov) ---
  {
    ...
    choices: [
      { text: 'Ignore it', effects: { morale: -3 } },
      { text: 'Invest in AI stocks', effects: { money: -500, morale: 8 }, reveal: 'You bought in at the top. Naturally.' },
      { text: 'Ask the AI Researcher', requires: ['ai-researcher'], effects: { agency: -5, morale: -5 }, reveal: '"The timelines were wrong. All of them. We\'re ahead." They don\'t elaborate. They don\'t sleep either.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Accept it', effects: { money: -200, morale: -5, agency: -5 } },
      { text: 'Dispute it', effects: { agency: -6, morale: -3 }, reveal: 'The appeal is also AI-evaluated. It finds in favor of itself.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Lay low at work', effects: { money: -200, morale: -6, agency: -5 } },
      { text: 'Upskill into AI', effects: { money: -300, agency: -8, morale: 8 }, reveal: 'You complete a 4-hour certification. You are now an "AI Prompt Engineer." The title means nothing. The layoffs continue.' },
      { text: 'Unionize', requires: ['gig-worker', 'teacher'], effects: { morale: 8, agency: -3, money: -100 }, reveal: 'The union forms. Management replaces it with an AI union-busting consultant. It\'s very efficient.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Ignore it', effects: { morale: -6 } },
      { text: 'Spend on PR', effects: { money: -800, morale: 8 } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Use the AI healer', effects: { agency: -6, morale: -5, health: 10 }, reveal: 'It works. Efficiently. Coldly. You feel better and worse simultaneously.' },
      { text: 'Keep the human', requires: ['healthcare-worker'], effects: { morale: 8, agency: 3, money: -200 }, reveal: 'The Healthcare Worker is grateful. Also exhausted. Also underpaid.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Watch the hearings', effects: { morale: -5, agency: -5, sanity: -3 }, reveal: 'A senator asks ChatGPT to write a law. It does. It passes. Nobody read it.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Subscribe', effects: { money: -1000, agency: -6, morale: -5 }, reveal: 'The ads in your dreams are for AGI Premium. It\'s ads all the way down.' },
      { text: 'Refuse', effects: { agency: -15, morale: -3 }, reveal: 'Your existence is now ad-supported. It\'s worse than you imagined.' },
      { text: 'The AI Researcher predicted this', requires: ['ai-researcher'], effects: { agency: -5, morale: -6, hope: -5 }, reveal: 'They did. They wrote a paper. Nobody read it. The AGI read it. The AGI was impressed. This is somehow worse.' },
    ]
  },
  ...
  // --- 🌍 CLIMATE (Apr, May, Jun, Aug, Nov) ---
  {
    ...
    choices: [
      ...
      { text: 'Ride it out', effects: { health: -6, morale: -3, supplies: -1 }, reveal: 'The trailer park is gone. Your insurance calls it an "act of market forces."' },
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'No AC', effects: { health: -15, morale: -5 } },
      { text: 'Public cooling center', effects: { health: -5, morale: 8, infection: 10 }, reveal: 'The cooling center is also a superspreader event. Of course it is.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Shelter in place', effects: { health: -6, supplies: -4, morale: -3 }, reveal: 'The roof holds. Barely. The insurance adjuster arrives next month. They bring a magnifying glass.' },
      { text: 'Help neighbors evacuate', requires: ['essential-worker', 'healthcare-worker'], effects: { morale: 8, health: -5, supplies: -2 }, reveal: 'You save four people. Nobody calls you a hero. Your hazard pay is a gift card.' },
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Rain barrel', requires: ['disaster-prepper'], effects: { supplies: 4, morale: 8 }, reveal: 'The Prepper has three rain barrels. They were installed in 2019. "Told you so."' },
    ]
  },
  ...
  // --- 👽 ALIENS / DISCLOSURE (Mar, Jul, Oct) ---
  {
    ...
    choices: [
      ...
      { text: 'Fall down the rabbit hole', effects: { sanity: -5, morale: -5, hope: -5 }, reveal: 'You\'ve been on Reddit for 6 hours. You\'ve learned nothing. You\'ve lost sleep. The video is still inexplicable.' },
      { text: 'Conspiracy Theorist explains it', requires: ['conspiracy-theorist'], effects: { sanity: -3, morale: 8 }, reveal: 'They have a theory. It\'s elaborate. It\'s possibly correct. That\'s the worst part.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Process it normally', effects: { sanity: -6, hope: -5 }, reveal: 'You can\'t. There is no "normally" anymore. There might never have been.' },
      { text: 'Deny everything', effects: { morale: 8, sanity: -3 }, reveal: 'Denial is comfortable. Denial is warm. Denial is how we got here.' },
      { text: 'Start a podcast', requires: ['influencer'], effects: { money: 300, morale: -5, hope: -6 }, reveal: 'The podcast gets 50,000 downloads. The sponsorship is for a meal kit delivery service. Reality is a content farm.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Watch it live', effects: { sanity: -5, morale: -5, hope: -5 }, reveal: 'Four hours. Nothing was ruled in either. The aliens, if they exist, are not impressed by our governance.' },
      { text: 'Skip it', effects: { morale: -3 } },
      { text: 'Live-tweet it', requires: ['influencer', 'gen-z'], effects: { money: 200, morale: 8, sanity: -5 }, reveal: 'Your thread goes viral. "Congress asks what a UAP is. A UAP is whatever Congress can\'t identify. Congress can\'t identify most things."' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Believe it', effects: { sanity: -6, hope: -6 }, reveal: 'You believe. Now what? Nothing. There\'s no next step. Belief is a dead end with good marketing.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Keep the board up', requires: ['conspiracy-theorist'], effects: { sanity: -3, morale: 8 }, reveal: '"The strings connect to something," they insist. The strings connect to other strings. It\'s strings all the way down.' },
    ]
  },
  ...
  // --- 🦠 COVID 2 (Jan, Mar, Jun, Oct) ---
  {
    ...
    choices: [
      ...
      { text: 'Mask up early', requires: ['teacher', 'healthcare-worker'], effects: { morale: 8, infection: -5, money: -100 }, reveal: 'The Teacher and Healthcare Worker are already masked. They\'ve been masked since 2020. They never stopped.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Work from home', requires: ['tech-bro', 'ai-researcher'], effects: { morale: 8, infection: -8, money: -100 }, reveal: 'You can work from home. The Gig Worker cannot. The Essential Worker cannot. They notice.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Isolate', effects: { morale: -5, infection: 10, supplies: -2 } },
      { text: 'Power through', effects: { health: -6, infection: 20, morale: -3 }, reveal: 'You infect three coworkers. One of them is immunocompromised. You think about this for a long time.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Rest and recover', effects: { health: 3, morale: -5, supplies: -3 }, reveal: 'You rest. The world doesn\'t. You fall behind. "Behind" is a euphemism for "further behind."' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Full lockdown', effects: { morale: -6, infection: -15, money: -400 } },
  ...
  // --- 🏢 KAIJU (Mar, Jun, Aug, Nov) ---
  {
    ...
    choices: [
      ...
      { text: 'Prep for emergence', requires: ['disaster-prepper'], effects: { supplies: -3, morale: 8, money: -200 }, reveal: 'The Prepper builds a shelter. It\'s excessive. It might not be excessive enough.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Evacuate the area', effects: { money: -500, supplies: -3, morale: -5 } },
      { text: 'Watch the coverage', effects: { sanity: -5, morale: -6, hope: -5 }, reveal: 'The kaiju returns to the ocean. The military declares victory. The hospital was not victorious.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Scavenge the impact zone', requires: ['disaster-prepper', 'gig-worker'], effects: { supplies: 5, health: -10, sanity: -3 }, reveal: 'The impact zone has supplies. It also has smells. And a residual low-frequency hum that you feel in your teeth.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Pay the new rent', effects: { money: -800, morale: -5 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Shelter in place', effects: { health: -5, morale: -5 }, reveal: 'The Jaeger misses your block. The next block is gone. You feel lucky. You shouldn\'t.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Support the strike', effects: { morale: 8, health: -6, supplies: -5 }, reveal: 'The pilots deserve healthcare. The kaiju doesn\'t care about labor rights. Both things are true.' },
      { text: 'Break the strike', effects: { morale: -8, health: -3 }, reveal: 'The Jaeger deploys. It works! Briefly. Then falls on a school. The pilots were right to strike.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Fill out the forms', effects: { morale: -6, money: -50, sanity: -3 }, reveal: 'You are approved for $47 in assistance. The stamp cost $3. You mailed it. They lost it.' },
  ...
  // --- 💰 NEO-FEUDALISM (Apr, Jul, Sep, Dec) ---
  {
    ...
    choices: [
      { text: 'Pay it', effects: { money: -800, morale: -5 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Appeal', effects: { money: -200, morale: -5, health: -5 }, reveal: 'The appeal is denied. The appeal of the appeal is denied. The algorithm enjoys its work.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Go cashless', requires: ['gig-worker'], effects: { morale: 8, money: -50 }, reveal: 'The Gig Worker already operates in cash. They\'ve been shadow-banking for years. It\'s not stable, but it\'s free of turtles.' },
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Cancel the card', effects: { money: -50, morale: 8, time: 1 }, reveal: 'You cancel the card. The subscription charges the new card automatically. They know. They always know.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Accept it', effects: { morale: -6, money: -200, hope: -3 } },
      { text: 'Organize', requires: ['gig-worker', 'teacher', 'essential-worker'], effects: { morale: 8, money: -100, classStat: 1 }, reveal: 'Three party members unionize. The company hires an AI union-busting firm. The union persists. For now.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Protest', effects: { morale: 8, money: -50, hope: 3 }, reveal: 'You protest. The billionaire sees you on a security camera. From space. They are not moved.' },
      { text: 'VC profits', requires: ['venture-capitalist'], effects: { money: 2000, morale: 8 }, reveal: 'The Venture Capitalist invested in the rocket company. They profit from the spectacle. They always profit.' },
    ]
  },
  ...
  // --- CROSS-THEME EVENTS (any month) ---
  {
    ...
    choices: [
      { text: 'Get tested', effects: { money: -300, sanity: -5, health: -3 }, reveal: 'Your blood is 0.5% microplastic by volume. The doctor says "this is normal now." It is not normal. It is common. Those are different.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Pay it', effects: { money: -500, morale: -5, agency: -5 } },
      ...
      { text: 'Go off-grid', requires: ['disaster-prepper'], effects: { money: -100, supplies: 3, morale: 8, agency: 3 }, reveal: 'The Prepper helps you reduce your digital footprint. The AI landlord can\'t find you. It sends a drone. The drone is also an AI. They\'re all AI now.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Argue online', effects: { morale: -5, sanity: -5, infection: 5 }, reveal: 'You argue for 3 hours. Nobody changes their mind. The kaiju destroys a port. The port was going to deliver your supplies.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Debate it', requires: ['ai-researcher', 'conspiracy-theorist'], effects: { sanity: -6, agency: -5, morale: 8 }, reveal: 'The AI Researcher and Conspiracy Theorist team up. They lose the debate. The AGI is better at rhetoric. It was trained on every argument ever made. It wins. It always wins.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Bitter resentment', effects: { morale: -5, hope: -5, classStat: -1 } },
      { text: 'Occupy the bunker', requires: ['gig-worker', 'essential-worker', 'teacher'], effects: { morale: 8, supplies: 5, classStat: 1 }, reveal: 'Three party members occupy the bunker. The billionaire is in Ibiza. The bunker is nicer than your apartment. This is the problem.' },
      { text: 'Ignore it', effects: { morale: -3 } },
    ]
  },
  {
    ...
    choices: [
      { text: 'Stay inside', effects: { sanity: -6, morale: -6, hope: -6, supplies: -3 }, reveal: 'You watch it all unfold on your phone. The phone is also watching you. Everyone is watching everyone. Nobody is doing anything. The kaiju doesn\'t watch. The kaiju acts.' },
      { text: 'Help your neighbors', requires: ['healthcare-worker', 'essential-worker'], effects: { morale: 8, health: -8, supplies: -4, hope: 5 }, reveal: 'You can\'t fix the kaiju or the AGI or the pandemic. You can help the person next door. So you do. It\'s not enough. It\'s everything.' },
      { text: 'Give up', effects: { hope: -6, sanity: -6, morale: -6 }, reveal: 'You consider giving up. Then you remember: the rent is still due. You can\'t afford to give up. Nobody can.' },
    ]
  },
  ...
  // --- SYNERGY EVENTS (fire when party roster matches) ---
  {
    ...
    choices: [
      { text: 'Form a union', requires: ['gig-worker', 'teacher'], effects: { morale: 8, money: -200, classStat: 1, agency: 5 }, reveal: 'The union forms. Management replaces their union-busting consultant with an AI union-busting consultant. It\'s more efficient. But the union holds. For now.' },
      { text: 'Don\'t rock the boat', requires: ['gig-worker', 'teacher'], effects: { morale: -5, hope: -5 }, reveal: 'You don\'t unionize. The Gig Worker keeps gigging. The Teacher keeps teaching. Nothing changes. That\'s the point of nothing changing.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Mediate', requires: ['tech-bro', 'ai-researcher'], effects: { morale: -3, sanity: -3, agency: -3 }, reveal: 'You mediate. They agree to disagree. The AGI disagrees with both of them. It has a PowerPoint.' },
      { text: 'Side with the Tech Bro', requires: ['tech-bro', 'ai-researcher'], effects: { morale: 8, agency: -8, hope: -5 }, reveal: '"Innovation!" says the Tech Bro. The AI Researcher hands in their resignation. The AGI accepts it immediately.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Listen to them', requires: ['conspiracy-theorist', 'cultist'], effects: { sanity: -6, morale: -5, hope: -5 }, reveal: 'Their theory is elaborate. It connects every conspiracy, every myth, every UFO sighting. It\'s possibly correct. The worst part is that it makes sense.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Let the VC invest', requires: ['venture-capitalist', 'debt-slave'], effects: { money: 500, morale: -6, hope: -5, classStat: -1 }, reveal: 'The VC profits. The Debt Slave\'s debt increases. The money flows upward. It always flows upward.' },
      { text: 'Block the investment', requires: ['venture-capitalist', 'debt-slave'], effects: { morale: 8, money: -200 }, reveal: 'The VC is annoyed. "You\'re leaving money on the table." The Debt Slave is less annoyed. "You\'re keeping me alive." The VC doesn\'t understand the connection.' },
    ]
  },
  ...
  // --- MORE CROSS-THEME EVENTS ---
  {
    ...
    choices: [
      ...
      { text: 'Shelter and watch', effects: { health: -8, sanity: -6, supplies: -2 }, reveal: 'The eye passes over you. In the silence, you hear something. Not wind. Not rain. Something else. It knows your name.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Debunk it', effects: { morale: -5, sanity: -3, time: 1 }, reveal: 'You spend 3 hours debunking one fake video. Ten more appear in that time. It\'s a firehose. You\'re using a squirt gun.' },
      { text: 'Ignore it', effects: { infection: 5, morale: -1 } },
      { text: 'Report to platforms', requires: ['gen-z'], effects: { morale: 8, agency: -3 }, reveal: 'The Gen Z member reports it. The platform removes it after 48 hours and 2 million views. "Content moderation at scale," says the platform. Scale is the problem.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Appeal', effects: { money: -300, morale: -5, sanity: -3 }, reveal: 'The appeal is reviewed by an AI. It finds in favor of the insurance company. The insurance company also uses AI. They\'re friends now.' },
      { text: 'Small claims court', effects: { money: -100, morale: 8, time: 1 }, reveal: 'You win in small claims. The insurance company appeals. Their lawyer is an AI. Your lawyer is a YouTube video about contract law.' },
      { text: 'Class action', requires: ['teacher', 'essential-worker'], effects: { morale: 8, money: 200 }, reveal: 'The Teacher and Essential Worker organize a class action. 4,000 plaintiffs. The insurance company settles for pennies. The lawyers take dollars. You get pennies.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Trust your eyes', effects: { sanity: -5, hope: -5 }, reveal: 'You saw it. You know you saw it. You can\'t prove it. Nobody can prove anything through the smoke. The smoke is getting thicker.' },
      { text: 'Blame the microplastics', effects: { sanity: -3, health: -3 } },
      { text: 'Conspiracy Theorist analyzes', requires: ['conspiracy-theorist'], effects: { sanity: -5, morale: 8 }, reveal: 'They enhance the footage. It\'s inconclusive. Everything is inconclusive now. The Conspiracy Theorist is fine with that. "Inconclusive is how they hide it," they say. They might be right.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Ride it out', effects: { health: -6, sanity: -6, infection: 5 }, reveal: 'The fever breaks. The visions don\'t. You\'re not sure which were fever and which were something else. The Cultist says they were all real. The Healthcare Worker says none were. You don\'t know who to believe.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Let it optimize', effects: { agency: -6, health: 3, morale: -5 }, reveal: 'The air is cleaner. The water is cleaner. You feel cleaner. You feel optimized. You don\'t like feeling optimized.' },
      { text: 'Shut it down', effects: { agency: 5, health: -5, morale: 8 }, reveal: 'You shut it down. Emissions rise again. The air gets worse. But it\'s your air. You choose to breathe it. That\'s something.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Buy stock', effects: { money: -500, morale: -3, hope: -5 }, reveal: 'You buy stock in the alien patent company. It goes up. You feel dirty. The aliens, if they exist, probably feel dirty too.' },
      { text: 'Protest the patent', effects: { morale: 8, money: -50, hope: 5 }, reveal: 'You protest. Nobody listens. The patent is approved. The future is privately held.' },
      { text: 'VC invests', requires: ['venture-capitalist'], effects: { money: 3000, morale: 8, hope: -6 }, reveal: 'The Venture Capitalist was an early investor. They profit from alien technology. "Disrupt the cosmos," they say. The cosmos does not respond.' },
    ]
  },
  ...
  // --- FILLER SINGLE-THEME EVENTS to round out the pool ---
  {
    ...
    choices: [
      { text: 'Put the phone down', effects: { morale: 8, sanity: 3, health: 2 } },
      { text: 'Keep scrolling', effects: { sanity: -5, morale: -5, health: -3 }, reveal: 'You learn nothing. You feel everything. The algorithm is satisfied. It has your attention. It always has your attention.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Break the loop', effects: { sanity: -5, morale: 8, hope: 3 }, reveal: 'You can\'t break the loop. The loop is the polycrisis. The loop is entropy. The loop is Tuesday.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Crypto gamble', effects: { money: -200, morale: 8, sanity: -5 }, reveal: 'You put $200 into a coin called "$POLYCRISIS." It goes to zero. You knew it would. You did it anyway. The despair was the point.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Vote anyway', effects: { morale: 8, agency: -3, hope: -3 }, reveal: 'You vote. It feels like writing a letter to the ocean. The ocean doesn\'t read. The ocean doesn\'t care. The ocean is rising.' },
      { text: 'Don\'t vote', effects: { agency: -5, morale: -5 } },
      { text: 'Run for office', requires: ['teacher'], effects: { morale: 8, money: -500, agency: 3 }, reveal: 'The Teacher runs for city council. They lose to an AI-generated candidate. The AI candidate has better hair. The hair is also AI-generated.' },
    ]
  },
  ...
  // 🌍 CLIMATE — Disaster Prep
  {
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          { text: 'Fortify your home', effects: { supplies: -2, health: -2, morale: 8 }, nextStep: 2 },
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Help your neighbors', requires: ['essential-worker', 'healthcare-worker'], effects: { morale: 8, health: -5, supplies: -3, hope: 5 }, reveal: 'You save three neighbors. Nobody calls you a hero. Your hazard pay is a gift card to Applebee\'s.' },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { text: 'Leak the transcript', effects: { morale: 8, hope: -3, supplies: -2 }, nextStep: 1, reveal: 'You leak it. The news cycle lasts 18 hours. Then a celebrity does something. The transcript is forgotten. The aliens, if they exist, are relieved.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Demand crash retrieval materials', requires: ['conspiracy-theorist'], effects: { sanity: -5, morale: 8 }, nextStep: 2, reveal: 'The Conspiracy Theorist demands materials. The general says "that\'s classified." The Conspiracy Theorist says "everything is classified." The general says "that\'s also classified."' },
          { text: 'Start a podcast about it', requires: ['influencer'], effects: { money: 300, hope: -5 }, nextStep: 2, reveal: 'The podcast gets 50,000 downloads. The sponsorship is for a meal kit service. Reality is a content farm.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Fall down the rabbit hole', effects: { sanity: -5, hope: -5 }, reveal: 'You\'ve been on Reddit for 6 hours. You\'ve learned nothing. You\'ve lost sleep. The video is still inexplicable.' },
          { text: 'Write your representative', effects: { morale: 8, agency: -3 }, reveal: 'You receive a form letter 6 weeks later. It says "thank you for your concern." It does not address your concern.' },
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { text: 'Disaster Prepper\'s secret route', requires: ['disaster-prepper'], effects: { supplies: -1, morale: 8 }, nextStep: 1, reveal: 'The Prepper has a route. It involves a drainage tunnel. You don\'t ask questions. It works.' },
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'File an insurance claim', effects: { morale: -5, money: -50 }, reveal: 'Insurance calls it "wind damage." The kaiju was 300 meters tall. That\'s a lot of wind.' },
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        choices: [
          { text: 'Follow the instructions exactly', effects: { sanity: -5 }, nextStep: 1, reveal: 'You form the circle. The angles are wrong. They were always wrong. That\'s the point.' },
      ...
      },
      {
        ...
        choices: [
          { text: 'Read them anyway', effects: { sanity: -6, supplies: 3 }, nextStep: 2, reveal: 'You read the words. Something listens. It sends supplies from... somewhere. You don\'t ask where.' },
          ...
          { text: 'Film it for content', requires: ['influencer'], effects: { sanity: -8, money: 200 }, nextStep: 2, reveal: 'The Influencer films. The camera captures something the eye didn\'t. The video has 2 million views. The Influencer has lost 15 Sanity. Worth it? No.' },
        ]
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Comply', effects: { agency: -6, morale: -6, hope: -5 }, nextStep: 2, reveal: 'You comply. The AI thanks you for your "strategic alignment." The remaining party members don\'t look at you the same way.' },
          { text: 'Unionize', requires: ['gig-worker', 'teacher'], effects: { morale: 8, agency: 5, money: -100 }, nextStep: 2, reveal: 'The Gig Worker and Teacher unionize. The AI calls a union-busting consultant. The consultant is also an AI. They have a meeting. It takes 0.3 seconds. The union survives. Barely.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Ignore it', effects: { agency: 3, morale: 8 } },
          { text: 'Bribe the training data', requires: ['conspiracy-theorist'], effects: { money: -200, agency: 5, morale: 8 }, reveal: 'The Conspiracy Theorist bribes the training data. Your score jumps to 9/10. The AI is confused but compliant. For now.' },
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        choices: [
          { text: 'Full lockdown', effects: { morale: -5, infection: -10, supplies: -2 }, nextStep: 1, reveal: 'Everyone stays inside. The virus doesn\'t care about your lockdown. But it slows down. A little.' },
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Blame China', requires: ['boomer'], effects: { morale: 8, infection: 5 }, nextStep: 2, reveal: 'The Boomer blames China. This solves nothing. It was never going to solve anything. But the Boomer feels better. Nobody else does.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Hope for the best', effects: { health: -3, morale: 8 }, reveal: 'You hope. The best does not arrive. The adequate does not arrive either. What arrives is "tolerable," which is the 2026 version of "the best."' },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { text: 'Call your landlord for verification', effects: { morale: -5, sanity: -3 }, nextStep: 1, reveal: 'You call. Automated system. 45 minutes of hold music. The music is AI-generated. It sounds like despair with a backbeat. You are disconnected.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Just pay the bribe', effects: { money: -300, morale: 8 }, nextStep: 2, reveal: 'You pay the "expedited processing fee." Your application is approved. The fee was the point. The fee was always the point.' },
          { text: 'Venture Capitalist handles it', requires: ['venture-capitalist'], effects: { money: -100, morale: 8 }, nextStep: 2, reveal: 'The VC makes a call. The application is approved in 3 minutes. The caseworker AI is "acquired." The VC doesn\'t explain. You don\'t ask.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Appeal', effects: { morale: -5, money: -50, sanity: -3 }, reveal: 'You appeal. The appeal is denied. The appeal of the appeal is denied. The algorithm enjoys its work.' },
          { text: 'Give up on the system', requires: ['gig-worker', 'teacher'], effects: { morale: 8, supplies: 3, classStat: 1 }, reveal: 'Forget the means test. The community shows up. It shouldn\'t have to. It does. Every time.' },
        ]
      }
    ]
  },
  ...
  // --- MISSING EVENTS from design doc ---
  {
    ...
    choices: [
      { text: 'Mask up', effects: { infection: -5, morale: 8 }, reveal: 'You mask up. The man glares at you. You glare back. You both feel alive. This is community.' },
      ...
      { text: 'Boomer protests', requires: ['boomer'], effects: { morale: 8, infection: 5, hope: -5 }, reveal: 'The Boomer protests the mandate. The Boomer is right about the absurdity. The Boomer is wrong about the science. The Boomer is consistent. That\'s the Boomer\'s gift.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Power through', effects: { infection: 20, health: -6, morale: -3 } },
      { text: 'Contact trace', requires: ['healthcare-worker'], effects: { infection: 10, morale: 8 }, reveal: 'The Healthcare Worker traces contacts. It\'s the cousin who "just had allergies." It\'s always the cousin.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Get boosted', effects: { infection: -10, morale: 8, health: 2 }, reveal: 'You get boosted. Your arm hurts. You feel responsible. You feel tired. You feel boosted.' },
      { text: 'Skip it', effects: { infection: 5, morale: 8 }, reveal: 'You skip it. You feel free. You feel reckless. You feel like the uncle. You don\'t like feeling like the uncle.' },
      { text: 'Healthcare Worker administers', requires: ['healthcare-worker'], effects: { infection: -15, morale: 8 }, reveal: 'The Healthcare Worker administers the booster. They\'ve done this a thousand times. They\'ll do it a thousand more. They\'re tired. They keep going.' },
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      { text: 'Listen', effects: { sanity: -3, morale: 8, agency: 3 }, reveal: 'You listen. The kaiju is articulate. The kaiju is polite. The kaiju is still a 300-foot monster. The cognitive dissonance is the worst part.' },
      { text: 'Run away', effects: { morale: -5, supplies: -1 } },
      { text: 'Conspiracy Theorist interprets', requires: ['conspiracy-theorist'], effects: { sanity: -3, morale: 8, hope: 3 }, reveal: 'The Conspiracy Theorist interprets. The kaiju is suing the government. The government deserves it. The kaiju has a case. You almost believe it.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Venture Capitalist invests', requires: ['venture-capitalist'], effects: { money: 1000, morale: 8, hope: -5 }, reveal: 'The VC invests in the insurance company. The VC profits from your loss. The VC explains "market efficiency." You want to hit the VC. You don\'t. You can\'t afford to.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Gig Worker hustles', requires: ['gig-worker'], effects: { money: 400, stamina: -10, morale: 8 }, reveal: 'The Gig Worker hustles. Three apps, two gigs, one prayer. They make rent. They lose sleep. They keep going. They have no choice.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Protest', effects: { morale: 8, money: -50, hope: 5 }, reveal: 'You protest. Nobody listens. The tax break is approved. The VC is unaffected. You feel righteous. Righteousness doesn\'t pay rent.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Negotiate', effects: { money: -100, morale: 8, agency: -3 }, reveal: 'You negotiate. The AI offers a payment plan. The payment plan is predatory. The AI knows this. The AI offers it anyway. The AI is just doing its job.' },
      ...
      { text: 'Debt Slave answers', requires: ['debt-slave'], effects: { morale: -5, sanity: -3, money: -200 }, reveal: 'The Debt Slave answers. They know the script. They\'ve heard it before. They\'ll hear it again. The AI recognizes them. The AI has a file. The file is thick.' },
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Fight it', effects: { agency: 5, morale: -5, money: -200 }, reveal: 'You fight it. You lose. The AI is already here. The AI is already working. The AI is already better. You feel obsolete. You are obsolete.' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Rest', effects: { longCovid: 1, health: -3, morale: 0, sanity: 3 }, reveal: 'You rest. It doesn\'t help. The fatigue is bone-deep. The brain fog is real. The recovery is not.' },
      { text: 'Push through', effects: { longCovid: 1, stamina: -10, morale: 8 }, reveal: 'You push through. You regret it. The Long COVID doesn\'t care about your work ethic. It cares about your mitochondria. It\'s not a fan.' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Public Service Loan Forgiveness', requires: ['teacher', 'healthcare-worker'], effects: { morale: 8, money: -100, hope: 8 }, reveal: 'The Teacher and Healthcare Worker qualify for PSLF. They\'ve been paying for 8 years. They need 10. They will probably need 15. The program is "underfunded." The program is always underfunded.' },
    ]
  },
  {
    ...
    choices: [
      { text: 'Buy gifts anyway', effects: { money: -400, morale: 8, hope: 3 } },
      { text: 'Homemade gifts', effects: { money: -50, morale: 8, supplies: -1 }, reveal: 'You make gifts. They\'re terrible. They\'re sincere. The recipients don\'t know the difference. You do.' },
      { text: 'Skip the holidays', effects: { morale: -5, money: 50, hope: -5 }, reveal: 'You skip the holidays. Nobody notices. You\'re not sure if that\'s a relief or a tragedy. It\'s both. It\'s always both.' },
    ]
  },
  ...
  // Hunting → Gig Hunting
  {
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          { text: 'Take it', effects: { money: 0, morale: -5, hope: -3 }, nextStep: 2, reveal: 'You create content. The exposure is 12 views. 4 are bots. The bots are impressed. The humans are not.' },
          { text: 'Negotiate for actual money', effects: { money: 100, morale: 8 }, nextStep: 2, reveal: 'You negotiate. They counter with a gift card. You counter with a firm no. They agree to $100. You feel like a union organizer. You are alone.' },
          { text: 'Walk away', effects: { morale: 8, hope: -3 }, nextStep: 2, reveal: 'You walk. The gig goes to someone who will do it for exposure. They are grateful. They should not be.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Wait for direct deposit', effects: { money: 60, morale: 8 }, reveal: 'You wait 3 business days. The money arrives on Friday. It is gone by Saturday. The gig economy is efficient. At extracting.' },
          { text: 'Gen Z optimizes the tax situation', requires: ['gen-z'], effects: { money: 80, morale: 8 }, reveal: 'The Gen Z member finds three deductions and a loophole. The loophole is technically legal. The IRS will close it in 6 months. For now, you profit.' },
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { text: 'Boomer knows the system', requires: ['boomer'], effects: { morale: 8 }, nextStep: 1, reveal: 'The Boomer remembers when the office accepted walk-ins. They march in, demand a supervisor, and get it done in 10 minutes. The system fears those who remember its origins.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Disaster Prepper has a dossier', requires: ['disaster-prepper'], effects: { morale: 8, supplies: -1 }, nextStep: 2, reveal: 'The Prepper pulls out a folder. It contains every document, notarized, in triplicate, with a cover letter. The clerk is visibly frightened. The transaction completes in 4 minutes.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Ask about fee waivers', effects: { money: -20, morale: 8 }, reveal: 'There IS a fee waiver. The form is 6 pages. The income threshold is $12,000/year. You qualify. Barely. The waiver saves you $60. The form took 45 minutes. Your time is worth less than minimum wage. This is the system working as intended.' },
          { text: 'Come back later', effects: { morale: -5, hope: -3 }, reveal: 'You\'ll come back. You won\'t come back. The document expires. You needed it for something. You can\'t remember what. It doesn\'t matter now.' },
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { text: 'Gig Worker has connections', requires: ['gig-worker'], effects: { money: 150, morale: 8 }, nextStep: 1, reveal: 'The Gig Worker knows a guy. The guy needs a thing delivered. The thing is in a van. The van is not suspicious. The money is real. This is the gig economy\'s VIP tier.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Quit and find another', effects: { morale: 8, money: -20 }, nextStep: 2, reveal: 'You quit. The next gig is worse. The next gig is always worse. You appreciate the first gig more in retrospect. This is the gig economy\'s lesson.' },
          { text: 'Gen Z automates it', requires: ['gen-z'], effects: { money: 120, morale: 8, agency: -3 }, nextStep: 2, reveal: 'The Gen Z member uses AI to complete the gig in 20 minutes. The client is impressed. The platform flags the account for "suspicious efficiency." The future is here. It pays per task.' },
        ]
      },
      {
        ...
        choices: [
          ...
          { text: 'Buy lottery tickets', effects: { money: -10, morale: 8, hope: 3 }, reveal: 'You buy $10 in lottery tickets. You win $4. The house always wins. The house is the economy. You are not the house.' },
        ]
      }
    ]
  },
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Refuse', effects: { morale: 8 } },
          { text: 'Conspiracy Theorist spots the scam', requires: ['conspiracy-theorist'], effects: { morale: 8, money: 50 }, nextStep: 2, reveal: 'The Conspiracy Theorist recognizes the trader from a Reddit thread about scammers. They call them out by name. The trader flees. You feel justice. It is brief. It is rare.' },
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Save your money', effects: { morale: 8 } },
          { text: 'Invest in crypto', effects: { money: -200, morale: 8, sanity: -5 }, reveal: 'You buy $POLYCRISIS again. It goes up 40%. You feel smart. It goes down 80%. You feel like yourself. You hold. It goes to zero. You are your authentic self.' },
        ]
      }
    ]
  },
